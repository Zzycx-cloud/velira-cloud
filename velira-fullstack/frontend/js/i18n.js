const DICT = {
  uz: {
    ...
    footAbout:"Konsentrlangan kir yuvish varaqlari zamonaviy uy uchun. O'zbekistonda rasmiy distribyutor.",
    ...
    heroTitle:"Kir yuvish endi<br><span class=\"accent\">bitta varaq</span>",
    heroSub:"Poroshoksiz, o'lchovsiz, dozasiz. Velira — konsentrlangan kir yuvish varaqlari, har qanday mashinaga mos.",
    ...
    featEyebrow:"Nega Velira", featTitle:"Kichik varaq, katta natija",
    ...
    s1t:"Varaqni oling", s1d:"Kerakli miqdorni ajratib oling — kichik yuklama uchun yarmi yetadi.",
    ...
    labelName:"Ismingiz", labelPhone:"Telefon raqam", labelAddress:"Manzil (ixtiyoriy)", labelComment:"Izoh (ixtiyoriy)",
    placeholderName:"Ism Familiya", placeholderPhone:"+998 90 000 00 00", placeholderAddress:"Shahar, ko'cha, uy",
    ...
    missionText:"Poroshok qutilari og'ir, o'lchash noqulay, ortiqcha kimyoviy moddalar esa terini quritadi. Biz bitta yupqa varaqda — to'g'ri doza, kuchli formula va yoqimli hidni birlashtirdik. Har bir varaq aniq bir marta yuvish uchun mo'ljallangan — ortiqcha sarflash yo'q.",
  ...
  ru: {
    ...
    heroTitle:"Стирка теперь —<br><span class=\"accent\">один лист</span>",
    ...
    labelName:"Ваше имя", labelPhone:"Номер телефона", labelAddress:"Адрес (необязательно)", labelComment:"Комментарий (необязательно)",
    placeholderName:"Имя Фамилия", placeholderPhone:"+998 90 000 00 00", placeholderAddress:"Город, улица, дом",
...
function initLang(){
  const saved = localStorage.getItem('velira_lang') || 'uz';
  applyLang(saved);
